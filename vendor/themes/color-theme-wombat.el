...
(defvar eshell-blue "#5fd7ff")
(defvar eshell-light-blue "#d7ffff")
(defvar eshell-light-green "#d7ffd7")
...
(defun color-theme-wombat ()
  ...
  (color-theme-install
   `(color-theme-wombat
     ...
     (eshell-prompt ((t (:foreground ,eshell-blue))))
     (eshell-ls-directory ((t (:foreground ,eshell-blue :width normal))))
